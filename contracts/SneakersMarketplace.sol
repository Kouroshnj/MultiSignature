...
contract SneakersMarketplace is ReentrancyGuard, UniswapV3Twap {
    address public owner;
    IERC20 public MMLaddress;
    IERC20 public USDTaddress;
    IERC721 public SneakersAddress;
    ...
    constructor(
        ...
        SneakersAddress = IERC721(SneakerToken);
    }
    ...
    //@dev Listing the Sneaker NFT in the marketplace.
    ...
    function listToken(
        ...
        marketItemIds += 1;
        SneakersAddress.transferFrom(msg.sender, address(this), _tokenId);
        ...
        nonReentrant
    {
        ...
        SneakersAddress.transferFrom(address(this), msg.sender, tokenID);
